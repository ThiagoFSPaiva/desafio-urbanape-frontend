...
@Directive({
  selector: '[appRouterLinkActiveExactDirective]',
  standalone: true
})
export class RouterLinkActiveExactDirectiveDirective {

  @Input('appRouterLinkActiveExactDirective') link: string | undefined; // Input to specify the link to match exactly
